...
contract NFTMarket is ReentrancyGuard {
  ...
  function createMarketSaleBytokenId(address nftContract, uint256 tokenId)
    public
    payable
    nonReentrant
  {
    ...
    uint256 itemId = tidToMarketItem[tokenId].itemId;
    require(
      tokenId == idToMarketItem[itemId].tokenId,
      "Sorry! tokenId error, we will fix it"
    );
    uint256 price = tidToMarketItem[tokenId].price;
